...
function Newrestaurant() {
  ...
  const handleSubmit = () => {
    ...
    axios.post(baseUrl("/manager/newrestaurant/"),
      form_data, {
      headers: {
      ...
      <center>
        <Card sx={{ maxWidth: 300, mt: 10 }}>
          <CardContent>
            ...
            <TextField name="name" label="hotel name" color="secondary" type="text" onChange={handle} inputRef={el => inputRef.current.name = el} />
            <br />
            <br />
            <TextField name="food_type" label="food" color="secondary" type="text" onChange={handle} inputRef={el => inputRef.current.food_type = el} />
            <br />
            <br />
            <TextField name="city" label="city" color="secondary" type="text" onChange={handle} inputRef={el => inputRef.current.city = el} />
            <br />
            <br />
            <TextField name="address" label="address" color="secondary" type="text" onChange={handle} inputRef={el => inputRef.current.address = el} />
            <br />
            <br />
            <TextField name="open_time" color="secondary" type="time" onChange={handle} inputRef={el => inputRef.current.open_time = el} />
            <br />
            <br />
            <TextField name="close_time" color="secondary" type="time" onChange={handle} inputRef={el => inputRef.current.close_time = el} />
            <br />
            <br />
